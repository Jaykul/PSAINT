...
namespace Sample {
   public class Reader
   {
      ...
      public void LoadFile(string fileName) {
         var content = _fs.ReadAllText(fileName);
...
## We need to mock out that File.ReadAll 
## otherwise our test depends on the existence of a file.
test "Reader.Load Results in Correct String Content" { 
   arrange {
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUue5Z4WWohKFQXp49c0m+HyXB
# sqmggg5CMIIHBjCCBO6gAwIBAgIBFTANBgkqhkiG9w0BAQUFADB9MQswCQYDVQQG
...
# AQQBgjcCAQsxDjAMBgorBgEEAYI3AgEWMCMGCSqGSIb3DQEJBDEWBBQRvHY4uz1m
# /1QHXMk23u7vTllyEjANBgkqhkiG9w0BAQEFAASCAQBaFQRHLeDzsiNeYZscgbU+
# 1P0VtYwLl7fGicMlsZfu8jHvqAwbv7JY+389sPtvEhci0nEUu5gMdUxBvYBO6WIB
# gE89lkx+eNvao3Ts5w8U2JEqXc+SJWX2fquMuXZxoPzZUdVRLx7BTjBn6ZzdQQS3
# gZGmH0yuJQ6juKaLvmjLDFdhcSrGfO2LTPH+FD65rXIOWbEgeEtJ8f/k0sZt4BOC
# /NKiPV870XQK4Vvj/eoMGUYnyzZewdtdxQ2fZZAIyre2GaxUPEJ9pxjdBGSd0ORs
# choXUY6PyvBSypw7zaHOkQ5Nf7mmgGATj5Zk+CRO1UwilE54hTvifHFKzlJkPokI
