   Start-Presentation 'Testing With PowerShell' C:\Users\Joel\Pictures\flow\Background6.jpg
   
   Add-TextSlide "What is Testing" @(
      ,"Unit Testing"
      ,"Functional Testing"
      ,"Acceptance Testing"
      ,"Common Themes?"
   ...
   Add-TextSlide "What do we test?" @( 
      ,"What do Administrators test?"  
      ,"What do Developers test?"      
      ,"What might users test?"        
   )
   
   Add-TextSlide "How do we test?" @(
   ...
   Add-TextSlide "Why test with PowerShell?" @(
      ,"Test your PowerShell"
      ,"Test .Net"
      ,"Test WebServices (even OData)"
      ,"Test UI (WASP)"
      ,"Test Web (WATIN)"
   )
   
   Add-TextSlide "Why NOT test with PowerShell?" @(
      ,"If you're testing .Net and:"
      ,"Generic Methods"
      ,"Extension Methods (LINQ)"
   )
      
   Add-TitleSlide "Lets Test Something!"
   ...
   Add-TextSlide "PowerShell Testing" @(
      ,"""Just Write PowerShell"""
      ,"We can test without tools"
      ,"And without dependencies"
      ,"Or Use PSUnit"
      ,"Or PowerTest"
   )
   
   Add-TextSlide "Lets Write Some Tests" @(
      ,"A Math Library"
   )
   
   Add-TextSlide "Unit Testing .Net" @(
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUgR7CUrKBQn6EiXd7ZImtBod2
# vEaggg5CMIIHBjCCBO6gAwIBAgIBFTANBgkqhkiG9w0BAQUFADB9MQswCQYDVQQG
...
# AQQBgjcCAQsxDjAMBgorBgEEAYI3AgEWMCMGCSqGSIb3DQEJBDEWBBQGtu1kR89p
# pG3whsv/ZNDmFD+QMzANBgkqhkiG9w0BAQEFAASCAQCCR4PL2Qa8wFolbPMJBXp3
# PUF9MzRd5CHdNya684ImNC52Fkpzn+ndFQD6TxQbPZzIYSN+EkCVHT7wpzNAEFrK
# ZxUvqQGnQaaNcZnUCZdm7CNxucHvgDu20AUnVM6aKN+SywrXl/UXpcCexneU6ySD
# 3YYgfwo195nfoFyLd2pjJNJmEB9xdLAMpDGalok7fHW0i7isorQEHp5KA3nw6W7a
# Kx8sk2AoRfjO7Qhi9W+UvBNwPbBFj/L+/Nh5S7F8CAuIdDTLFKifCNiDK1Qr+hFZ
# UyScOvfGuuAWyNyszAi+hV0MflfI95jkBuKwgV7HnULTjCqQYOi3wOY3BUuapzgH
